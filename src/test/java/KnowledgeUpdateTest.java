...
public class KnowledgeUpdateTest {
   ...
   public void stringConstructorUpdateTypeSet() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test1::Banana := 4.0");
   ...
   public void stringConstructorUpdateTypeMultiply() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test1::Banana *= _pizzaa::Pie1");
   ...
   public void stringConstructorUpdateTypeSubtract() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("test1::Banana -= !test2::Apple");
   ...
   public void stringConstructorConstantStringListSuccess() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test51::BananaPhone := [\"hello, world!\"]");
   ...
   public void stringConstructorFrameSettingType() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test_51::BananaPhone := test251");
   ...
   public void stringConstructorKnowledgeSettingType() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test51::BananaPhone := !test251::pizza");
   ...
   public void stringConstructorConstantNumberListValue() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test51::BananaPhone := [4.0, 1.2312, 1213123]");
   ...
   public void stringConstructorRemoveNumberFromList() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test51::BananaPhone -= 4.0");
   ...
   public void stringConstructorFrame() throws KnowledgeException {
      KnowledgeUpdate knowledgeUpdate = new KnowledgeUpdate("!test51::BananaPhone3 *= !test251");
      KnowledgeUpdate knowledgeUpdate1 = new KnowledgeUpdate(UpdateType.MULTIPLY, "test51", "BananaPhone3", "!test251");
      assertEquals(knowledgeUpdate, knowledgeUpdate1);
   }
}